...
x=[2,3,5]x = [2, 3, 5]x=[2,3,5]

Вектор весов модели

w=[0.4,0.1,0.5]w = [0.4, 0.1, 0.5]w=[0.4,0.1,0.5]
...
u1=[5,0,1]u2=[4,1,0]u3=[0,3,5]u_1 = [5, 0, 1] u_2 = [4, 1, 0] u_3 = [0, 3, 5]u1​=[5,0,1]u2​=[4,1,0]u3​=[0,3,5]
...
W=[2001]W = \begin{bmatrix} 2 & 0 \\ 0 & 1 \end{bmatrix}W=[20​01​]
...
A=[1224],B=[1234]A = \begin{bmatrix} 1 & 2 \\ 2 & 4 \end{bmatrix}, \quad B = \begin{bmatrix} 1 & 2 \\ 3 & 4 \end{bmatrix}A=[12​24​],B=[13​24​]
...
A=[4363]A = \begin{bmatrix} 4 & 3 \\ 6 & 3 \end{bmatrix}A=[46​33​]

Два вектора правой части:

b1=[10,12],b2=[8,10]b_1 = [10, 12], \quad b_2 = [8, 10]b1​=[10,12],b2​=[8,10]
